...
(function ($, window, undefined) {
	function JSCountdown(opts) {
		if (!(this instanceof JSCountdown)) {
			return new JSCountdown(opts);
		}	
		this.options = {};
		this.total   = null;
		this.days    = null;
	...
	JSCountdown.prototype = {
		init: function (opts) {
			...
			self.$container = $(".js-countdown-container");
			
			self.$container.on("click", ".jsCountdownSubscribeSelector", function(e){
...
<!--hari-->
		setDays: function(){
            ...
            var cdays = $(".js-days-canvas").get(0);
            ...
            ctx.lineWidth = 3;
            ctx.stroke();
            self.$container.find(".js-clock-days-container .js-value").text(self.days);
        },
<!--jam-->
        setHours: function(){
        	var  self = this;
        	
            var cHr = $(".js-hours-canvas").get(0);
            ...
            ctx.lineWidth = 3;
            ctx.stroke();
            self.$container.find(".js-clock-hours-container .js-value").text(24 - self.hours);
        },
<!--menit-->
        setMinutes : function(){
        	var  self = this;
        	
            var cMin = $(".js-minutes-canvas").get(0);
            ...
            ctx.lineWidth = 3;
            ctx.stroke();
            self.$container.find(".js-clock-minutes-container .js-value").text(60 - self.minutes);
        },
<!--detik-->
        setSeconds: function(){
        	var  self = this;
        	
            var cSec = $(".js-seconds-canvas").get(0);
            ...
            self.$container.find(".js-clock-seconds-container .js-value").text(60 - self.seconds);
        },
	...
	return (window.JSCountdown = JSCountdown);
